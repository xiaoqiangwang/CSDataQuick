...
Row {
    ...
    onValueChanged: {
        ...
        if (value !== undefined) {
            if (value === "AlignLeft" || backendValue.value === Text.AlignLeft) {
                buttonRow.initalChecked = 0
                buttonRow.checkedIndex = 0
            } else if (value === "AlignHCenter" || backendValue.value === Text.AlignHCenter) {
                buttonRow.initalChecked = 1
                buttonRow.checkedIndex = 1
            } else if (value === "AlignRight" || backendValue.value === Text.AlignRight) {
