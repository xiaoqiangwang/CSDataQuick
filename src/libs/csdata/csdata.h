...
class CSDATA_EXPORT QCSDataAlarm : public QObject
{
    Q_OBJECT
...
class CSDATA_EXPORT QCSDataRange : public QObject
{
    Q_OBJECT
...
class CSDATA_EXPORT QCSData : public QObject
{
    Q_OBJECT
...
public:
    ...
    Q_INVOKABLE void setExtraProperty(const QString name, const QVariant value);
    QVariant extraProperty(const QString name) const;
