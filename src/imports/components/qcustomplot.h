...
#ifdef QCP_USE_DEVICEPIXELRATIO // XW: default disabled
...
public:
  ...
  */
  ...
  explicit QCustomPlot(QObject *parent = nullptr);  // XW: Derive from QObject instead of QWidget
  ...
  void setRect(QRect rect) {mRect = rect; mSize = rect.size(); }
...
protected:
  ...
  // reimplemented virtual methods:
  virtual QSize minimumSizeHint() const; //XW: N/A Q_DECL_OVERRIDE;
  virtual QSize sizeHint() const; //XW: N/A Q_DECL_OVERRIDE;
  //virtual void paintEvent(QPaintEvent *event) Q_DECL_OVERRIDE; // XW: incompaitble QWidget method
  virtual void resizeEvent(QResizeEvent *event); //XW: N/A Q_DECL_OVERRIDE;
  virtual void mouseDoubleClickEvent(QMouseEvent *event); //XW: N/A Q_DECL_OVERRIDE;
  virtual void mousePressEvent(QMouseEvent *event); //XW: N/A Q_DECL_OVERRIDE;
  virtual void mouseMoveEvent(QMouseEvent *event); //XW: N/A Q_DECL_OVERRIDE;
  virtual void mouseReleaseEvent(QMouseEvent *event); //XW: N/A Q_DECL_OVERRIDE;
  virtual void wheelEvent(QWheelEvent *event); //XW: N/A Q_DECL_OVERRIDE;
